class HouseholdsController < ApplicationController
  ...
  private
    ...
    def household_params
      params.require(:household).permit(:headname, :headdob, :headgender, :headethicity, :numadults, :numchild, :streetaddr, :city, :state, :county, :zipcode, :phonenum, :incomesource, :qualifiercode, :netincome, :householdtype)
    end
end
